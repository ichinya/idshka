...
1. T1: Gateway runtime dependencies и config surface
   ...
   - Добавить config для `issuer`, `audience=example.test`, internal `jwks_url`, allowed `alg`, JWKS TTL/stale policy.
...
3. T3: `infra/openresty/demo-resource/lua/jwks_cache.lua`
...
4. T4: `infra/openresty/demo-resource/lua/jwt_validate.lua`
...
5. T5: `infra/openresty/demo-resource/lua/context_headers.lua`
...
7. T7: Minimal `demo-resource-api` smoke upstream
...
9. T9: Docs sync и implementation notes
   ...
   - Обновить `infra/openresty/demo-resource/lua/README.md`.
